...
const Index = () => {
  const ref = useRef()
  const [next, setNext] = useState('navy')

  const handleBeforeLeave = (_, destination) => {
  ...
  return (
    <div className="home">
      <div className="nav-arrow">
        <div
          className={`nav-arrow-up mx-auto ${next !== 'navy' && 'active'}`}
          onClick={() => ref.current.fullpageApi.moveSectionUp()}
        />
        <div
          className={`nav-arrow-down mx-auto mt-3 ${
            next !== 'contact' && 'active'
          }`}
          onClick={() => ref.current.fullpageApi.moveSectionDown()}
        />
        <div className="line mx-auto mt-3" />
      </div>
      <ReactFullpage
        ref={ref}
        licenseKey="YOUR_KEY_HERE"
        scrollingSpeed={1000}
        anchors={['navy', 'voyager', 'drifter', 'collection', 'contact']}
        menu={'#myMenu'}
        navigation={true}
              ...
              <div className="section fp-auto-height">
                ...
                <div id="#navy" className="section1 text-end">
                  ...
                  <div className="section1__content text-start">
                    ...
                    <h2 className="text-uppercase mt-3 mt-xs-5">Navy Salt & Pepper</h2>
                  </div>
                  <div className="section1__gear line-left text-main ps-3">
                    Gear UP
                  </div>
                </div>
              </div>
              <div className="section fp-auto-height">
                <div id="#voyager" className="section2 text-start">
                  ...
                  <div className="section2__content text-start">
                    <p className="ms-auto">
                      Whether you’re stomping around outdoors or traversing the
                      city, our Voyager Daypack was designed to be adaptable in
                      all enviroments. Compact, lightweight  and a
                      comfortable for people of all size. This silhouette is
                      versatile enough
                    </p>
                  ...
                  <div className="section2__title text-white">
                    VOYAGER DAYPACK
                  </div>
                  <div className="section2__sub text-white">
                    NAVY SALT & PEPPER
                  </div>
                </div>
              </div>
                ...
                <div id="#drifter" className="section3 text-end">
                  ...
                  <div className="section3__content text-start">
                    <p className="me-auto mb-0">
                      Field-tested from the peaks of the Cascades down to the
                      desert floor of Joshua Tree, the Wilderess Rucksack was
                      build to put on some serous miles for years to come. A
                      comfortable, dependable combination of 14oz Salt & Pepper
                      canvas, premium wool felt, and Cambara English bridle
                      leather.
                    </p>
                  ...
                  <div className="row1 position-relative mx-auto">
                    <div className="section4__content detail1 text-start mt-5">
                      ...
                      <div className="des mt-5">
                        ...
                        <p className="mt-4 ms-xl-auto">
                          We designed our Nomad Duffle as a versatile yet rugged
                          piece of luggage that&#39;s just as comfortable
                          putdoors as it is in an overhead compartment
                          <br />
                    ...
                    <div className="section4__content detail2">
                      <div className="des text-start">
                        ...
                        <p className="mt-4">
                          This bag can be carried by hand, worn as a backpack or
                          slung over a shoulder depending on your traveling
                          needs
                          <br />
                    ...
                    <div className="section4__content detail4 text-end">
                      <div className="des ms-auto">
                        ...
                        <p className="mt-4 mb-0">
                          Our field camera bag is constructed from 14oz Salt &
                          Pepper canvas and Cambara Meridian English bridle
                          leather. We&#39;ve put these bags through the ringer
                          in testing and we think you&#39;ll approve of the
                          result. Our Cammera Bag is fully lined and padded, and
